...
(N'Mực một nắng',1,120000),
(N'Nghêu hấp xả',1,60000),
(N'Vú dê nướng',2,70000),
(N'Heo rừng nướng muối ớt',3,80000),
(N'Côm chiên mushi',4,40000)
 go
 --Thêm bill
 ...
 (1,6,2),  (1,6,4),(1,7,1),(2,8,2),(2,8,2),(3,9,2)
 go
